...
#EDIT THE FOLLOWING:
$toAddress = "james.jennings@seattlecentral.edu";  //place your/your client's email address here
$toName = "James Jennings"; //place your client's name here
$website = "jamesbartonjennings.com";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
$sendEmail = TRUE; //if true, will send an email, otherwise just show user data.
$dateFeedback = true; //if true will show date/time with reCAPTCHA error - style a div with class of dateFeedback
include_once 'emmacooks-config.php'; #site keys go inside your config.php file
...
?>
	...
	<div>	
		<label>
			Comments:<br /><textarea name="Comments" required="required" cols="36" rows="4" placeholder="Your comments are important to us!" tabindex="30"></textarea>
		</label>
	</div>	
	<div><?=$feedback?></div>
